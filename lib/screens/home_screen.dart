...
import 'package:job_finder_app_ui/screens/job_screen.dart';
import 'package:job_finder_app_ui/widgets/featured_job_widget.dart';
import 'package:job_finder_app_ui/widgets/popular_job_widget.dart';
import 'package:job_finder_app_ui/widgets/recommended_job_widget.dart';
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          items: [
            ...
            BottomNavigationBarItem(icon: Icon(Icons.mail), label: '1'),
            BottomNavigationBarItem(icon: Icon(Icons.bookmark), label: '1'),
            BottomNavigationBarItem(icon: Icon(Icons.widgets), label: '1'),
          ],
